...
(function ($)
{
    ...
    $.ligerDefaults.GridString = {
        errorMessage: '发生错误',
        pageStatMessage: 'Hiển thị tổng số {total} mục từ {from} đến {to}. Hiển thị trên mỗi trang: {pagesize}',
...
(function ($)
{
    ...
    $.ligerui.controls.MenuBar.ligerExtend($.ligerui.core.UIComponent, {
        ...
        //  end button
            ...
            var ditem = $('<div class="l-toolbar-item-text l-panel-text"><span></span><div class="l-panel-text-l"></div><div class="l-panel-text-r"></div></div>');
            g.menubar.append(ditem);
            item.id && ditem.attr("menubarid", item.id);                      
            $(".l-panel-text-r", ditem).html('<input type="text">');
        }
    }
    });
})(jQuery);﻿/**
